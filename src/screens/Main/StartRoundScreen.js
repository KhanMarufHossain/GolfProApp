...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: horizontalScale(16), paddingVertical: verticalScale(12) },
  headerBack: { width: horizontalScale(36), height: horizontalScale(36), justifyContent: 'center', alignItems: 'center' },
  headerBackTxt: { fontSize: moderateScale(20), color: '#222' },
  headerTitle: { flex: 1, textAlign: 'center', fontSize: moderateScale(18), fontWeight: '700' },
  container: { flex: 1, paddingHorizontal: horizontalScale(20) },
  sectionLabel: { fontSize: moderateScale(14), fontWeight: '700', marginTop: verticalScale(8), color: '#222' },
  courseLink: { color: '#B5602E', marginTop: verticalScale(6), fontWeight: '600' },
  roundTypeRow: { flexDirection: 'row', marginTop: verticalScale(8) },
  roundTypeBtn: { paddingVertical: verticalScale(10), paddingHorizontal: horizontalScale(18), borderRadius: moderateScale(8), backgroundColor: '#F5EDE8', marginRight: horizontalScale(8) },
  roundTypeBtnActive: { borderWidth: 1, borderColor: '#B5602E', backgroundColor: '#fff' },
  roundTypeBtnActiveAlt: { backgroundColor: '#F5EDE8' },
  roundTypeTxt: { color: '#8B5C2A', fontWeight: '700' },
  ...
  removeBtn: { backgroundColor: '#8B5C2A', width: horizontalScale(36), height: horizontalScale(36), borderRadius: horizontalScale(18), justifyContent: 'center', alignItems: 'center' },
  removeTxt: { color: '#fff', fontWeight: '700' },
  playBtn: { marginTop: verticalScale(18), backgroundColor: '#8B5C2A', paddingVertical: verticalScale(14), borderRadius: moderateScale(12), alignItems: 'center', flexDirection: 'row', justifyContent: 'center' },
